/**
 * Monochrome line icons (Feather-style) drawn as inline SVG so they inherit
 * `currentColor` and stay crisp — no emoji, no external assets.
 */
...
/** Door with an exiting arrow (log-out / leave). */
